...
public void onRequestOnlineProcess(Bundle aaResult) throws RemoteException {
     ...
     * <li>PAYPASS_COMPLETE(301)-paypass简易流程完成 | paypass complete</li>
     * <li>PAYPASS_EMV_TC(304)-paypass交易结果，交易批准 </li>
     * <li>PAYPASS_EMV_AAC(305)-paypass交易结果，交易拒绝| paypass result, refuse</li>
     * <li>PAYPASS_EMV_ERROR(306)-paypass交易结果，交易失败</li>
     * <li>PAYPASS_END_APP(307)-paypass交易结果，交易终止</li>
     * <li>PAYPASS_TRYOTHER(308)-paypass交易结果，转其他读卡界面 | paypass result, try other (contact, magnetic card)</li>
