package com.test.ui.views.keyboard_view;
        ...
        extends View
{
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        LogUtil.d(TAG, "onMeasure widthMeasureSpec=" + widthMeasureSpec + " heightMeasureSpec=" + heightMeasureSpec);
        ...
        for (;;)
        {
            if (widthMeasureSpec < 100)
            {
                ...
                if ((f1 - f2 > this.height / 8.0F) || (f3 > this.width / 8.0F)) {
                    ...
                    LogUtil.d(TAG, "contentsize=" + contentsize);
                    break;
                }
            }
            else
            {
                LogUtil.d(TAG, "widthMeasureSpec > 100 ,set contentsize to default 46");
                this.contentsize = 46;
                setMeasuredDimension((int)this.width, (int)this.height);
                break;
            }
