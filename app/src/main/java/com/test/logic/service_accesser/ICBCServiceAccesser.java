...
public class ICBCServiceAccesser extends ServiceAccesser {
    private final String serviceAction = "com.icbc.smartpos.device_service";
    private final String servicePackageName = "com.icbc.smartpos.deviceservice";
    private final String serviceClassName = "com.verifone.smartpos.service.VerifoneDeviceService";

    private ServiceConnection connection;
    private static ICBCServiceAccesser instance;

    private boolean isConnected; /* 是否服务已经连接上 */
    private IBinder iBinder; /* 连接service返回的binder */

    public ICBCServiceAccesser() {
        connection = createServiceConnection();
        isConnected = false;
        iBinder = null;
    }

    public static ICBCServiceAccesser getInstance() {
        if (instance == null) {
            instance = new ICBCServiceAccesser();
        }
