...
import com.icbc.smartpos.deviceservice.aidl.KeyBoardConfig;
import com.icbc.smartpos.deviceservice.aidl.PinInputListener;
import com.icbc.smartpos.deviceservice.aidl.PinpadKeyType;
...
public class ModulePinpad extends BaseModule {
    ...
    public ModulePinpad() {
        try {
            aidlPinpad = DeviceService.getDeviceService().getPinpad(1);
    ...
    public void API06_startPinInput(int keyId, Bundle param, PinInputListener listener) {
        try {
            aidlPinpad.startPinInput(keyId, param, listener);
        } catch (RemoteException e) {
            e.printStackTrace();
        }
    }
    ...
    @CaseAttributes(isSupportAutoTest = true)
    public boolean CASE_loadTEK_CN00k1Id1() {
    ...
    @CaseAttributes(isSupportAutoTest = true)
    public boolean CASE_loadMainKey_CN00k1Id1() {
    ...
    @CaseAttributes(isSupportAutoTest = true)
    public boolean CASE_loadMainKey_CN00k1Id1_16() {
        String key = "FCAD332CE832FC41C22B74F0FC49271B";
        String checkValue = "0D544C574919CBF6";
        //String key = "158F16098CA2D773158F16098CA2D77300CE7E2DE598A1A115";
        int keyId = 1;
        return API03_loadEncryptMainKey(keyId, StringUtil.hexStr2Bytes(key), StringUtil.hexStr2Bytes(checkValue));
    }

    @CaseAttributes(isSupportAutoTest = true)
    public boolean CASE_loadWorkKey_CN00k1Id1M1() {
    ...
    public boolean CASE_loadWorkKey_CN00k1Id1M1_16() {
        String key = "89B07B35A1B3F47E89B07B35A1B3F488";
