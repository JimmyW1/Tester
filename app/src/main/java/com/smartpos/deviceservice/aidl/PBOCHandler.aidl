...
interface PBOCHandler {
     ...
     * <ul>
     * <li>RESULT(int) - 结果类型：
     *   |----QPBOC_ARQC(201) - qPBOC联机请求;
     *   |----AARESULT_ARQC(2) - 行为分析结果ARQC
     *   |----PAYPASS_MAG_ARQC(302)-paypass的磁卡模式联机请求
     *   |----PAYPASS_EMV_ARQC(303)- paypass的EMV模式联机请求
     * <li>ARQC_DATA(String) - 联机请求卡片55域数据 </li>
     * <li>REVERSAL_DATA(String) - IC卡冲正TLV数据 </li>
     * <li>CARD_ORG(String)-卡组织类别</li>
     * <li>PAN(String)-交易卡号</li>
     * <li>TRACK2(String)-磁道2数据（包括磁条卡、IC卡和非接卡）</li>
     * <li>EXPIRED_DATE(String)-</li>
     * <li>CARD_SN(String)-卡片序列号</li>
     * <li>DATE(String)-交易日期</li>
     * <li>TIME(String)-交易时间</li>
     ...
     * <li>PAYPASS_EMV_AAC(305)-paypass交易结果，交易拒绝</li>
     * <li>PAYPASS_EMV_ERROR(306)-paypass交易结果，交易失败</li>
     * <li>PAYPASS_END_APP(307)-paypass交易结果，交易终止</li>
     * <li>PAYPASS_TRYOTHER(308)-paypass交易结果，转其他读卡界面</li>
     * <li>EMV_SEE_PHONE(150)-paypass交易结果，请查看手机</li>
     * </ul>
     *
     * @param data 交易结果数据
     * <ul>
