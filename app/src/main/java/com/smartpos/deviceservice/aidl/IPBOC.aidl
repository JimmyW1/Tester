...
import com.smartpos.deviceservice.aidl.CheckCardListener;
import com.smartpos.deviceservice.aidl.UPCardListener;
import com.smartpos.deviceservice.aidl.PBOCHandler;
import com.smartpos.deviceservice.aidl.OnlineResultHandler;
import com.smartpos.deviceservice.aidl.CandidateAppInfo;
...
interface IPBOC {
    ...
    /**
     * 获取AID参数,如果Aid为空，返回null
     */
	String[] getAID();

    /**
     * 获取RID参数,如果Rid为空，返回null
     */
	String[] getRID();
}
